				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group date" id="dp1">
						...
						<input type="text" name="datainizio" id="datainizio"
							   ...
							   value="<%=formato.format(c.getData_iniziocorso())%>">
					</div>
				</div>
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group date" id="dp2">
						...
						<input type="text" name="datafine" id="datafine"
							   placeholder="DD/MM/YYYY" class="form-control"
							   value="<%=formato.format(c.getData_finecorso())%>">
					</div>
				</div>
